...
void spaceship1_graphics_comp::update()
{
  ...
  SDL_RenderCopyEx(gfx.renderer,
                   gfx.tex_shelf.get_texture("WO84-wu-X1"), nullptr,
                   &go.rect, go.motion.angle + 90, nullptr, SDL_FLIP_NONE);
}
spaceship1_graphics_comp::spaceship1_graphics_comp(const game_object &go,
                                                   const graphics &gfx)
  : go(go), gfx(gfx)
{}
