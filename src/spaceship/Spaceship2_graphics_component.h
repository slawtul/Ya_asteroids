...
struct Spaceship2_graphics_component: Graphics_component
{
    void update(Game_object &obj, Graphics &graphics) override
    {
        ...
        auto[x, y] = calc_position_if_edge_screen_reached(obj.rect.x, obj.rect.y, obj.rect.w,
                                                          obj.rect.h, graphics);
        obj.rect.x = x;
        obj.rect.y = y;

        SDL_RenderCopyEx(graphics.renderer, graphics.texture_shelf.get_texture("CX16-X1"),
