...
SDL_Window* sdl2_helpers::create_window(const char* title, int screen_width, int screen_height,
        uint32_t flags)
{
    const auto window = SDL_CreateWindow(title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
